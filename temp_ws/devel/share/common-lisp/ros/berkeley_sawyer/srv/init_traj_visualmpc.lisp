...
(cl:defmethod cl:initialize-instance :after ((m <init_traj_visualmpc-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'init_traj_visualmpc-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name berkeley_sawyer-srv:<init_traj_visualmpc-request> is deprecated: use berkeley_sawyer-srv:init_traj_visualmpc-request instead.")))
...
(cl:defmethod goalmain-val ((m <init_traj_visualmpc-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader berkeley_sawyer-srv:goalmain-val is deprecated.  Use berkeley_sawyer-srv:goalmain instead.")
  (goalmain m))

(cl:ensure-generic-function 'goalaux1-val :lambda-list '(m))
(cl:defmethod goalaux1-val ((m <init_traj_visualmpc-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader berkeley_sawyer-srv:goalaux1-val is deprecated.  Use berkeley_sawyer-srv:goalaux1 instead.")
  (goalaux1 m))

(cl:ensure-generic-function 'save_subdir-val :lambda-list '(m))
(cl:defmethod save_subdir-val ((m <init_traj_visualmpc-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader berkeley_sawyer-srv:save_subdir-val is deprecated.  Use berkeley_sawyer-srv:save_subdir instead.")
  (save_subdir m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<init_traj_visualmpc-request>)))
  ...
  "berkeley_sawyer/init_traj_visualmpcRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'init_traj_visualmpc-request)))
  "Returns string type for a service object of type 'init_traj_visualmpc-request"
  "berkeley_sawyer/init_traj_visualmpcRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <init_traj_visualmpc-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'init_traj_visualmpc-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name berkeley_sawyer-srv:<init_traj_visualmpc-response> is deprecated: use berkeley_sawyer-srv:init_traj_visualmpc-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<init_traj_visualmpc-response>)))
  ...
  "berkeley_sawyer/init_traj_visualmpcResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'init_traj_visualmpc-response)))
  "Returns string type for a service object of type 'init_traj_visualmpc-response"
  "berkeley_sawyer/init_traj_visualmpcResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'init_traj_visualmpc)))
  ...
  "berkeley_sawyer/init_traj_visualmpc")