...
(cl:defmethod cl:initialize-instance :after ((m <GetVisualNames-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetVisualNames-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_ext_msgs-srv:<GetVisualNames-request> is deprecated: use gazebo_ext_msgs-srv:GetVisualNames-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetVisualNames-request>)))
  ...
  "gazebo_ext_msgs/GetVisualNamesRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetVisualNames-request)))
  "Returns string type for a service object of type 'GetVisualNames-request"
  "gazebo_ext_msgs/GetVisualNamesRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GetVisualNames-request>)))
  ...
  "84bee8e2f694c3877c28343b65184d47")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GetVisualNames-request)))
  "Returns md5sum for a message object of type 'GetVisualNames-request"
  "84bee8e2f694c3877c28343b65184d47")
...
(cl:defclass <GetVisualNames-response> (roslisp-msg-protocol:ros-message)
  ((link_visual_names
    :reader link_visual_names
    :initarg :link_visual_names
    :type (cl:vector cl:string)
   :initform (cl:make-array 0 :element-type 'cl:string :initial-element ""))
   (success
    :reader success
...
(cl:defmethod cl:initialize-instance :after ((m <GetVisualNames-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetVisualNames-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_ext_msgs-srv:<GetVisualNames-response> is deprecated: use gazebo_ext_msgs-srv:GetVisualNames-response instead.")))

(cl:ensure-generic-function 'link_visual_names-val :lambda-list '(m))
(cl:defmethod link_visual_names-val ((m <GetVisualNames-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_ext_msgs-srv:link_visual_names-val is deprecated.  Use gazebo_ext_msgs-srv:link_visual_names instead.")
  (link_visual_names m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <GetVisualNames-response>) ostream)
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'link_visual_names))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (cl:let ((__ros_str_len (cl:length ele)))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) ele))
   (cl:slot-value msg 'link_visual_names))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <GetVisualNames-response>) istream)
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'link_visual_names) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'link_visual_names)))
    (cl:dotimes (i __ros_arr_len)
    (cl:let ((__ros_str_len 0))
      (cl:setf (cl:ldb (cl:byte 8 0) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) __ros_str_len) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetVisualNames-response>)))
  ...
  "gazebo_ext_msgs/GetVisualNamesResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetVisualNames-response)))
  "Returns string type for a service object of type 'GetVisualNames-response"
  "gazebo_ext_msgs/GetVisualNamesResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetVisualNames-response>)))
  ...
  (cl:format cl:nil "string[] link_visual_names~%bool success~%string status_message~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetVisualNames-response)))
  "Returns full string definition for message of type 'GetVisualNames-response"
  (cl:format cl:nil "string[] link_visual_names~%bool success~%string status_message~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <GetVisualNames-response>))
  (cl:+ 0
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'link_visual_names) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4 (cl:length ele))))
     1
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <GetVisualNames-response>))
  ...
  (cl:list 'GetVisualNames-response
    (cl:cons ':link_visual_names (link_visual_names msg))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetVisualNames)))
  ...
  "gazebo_ext_msgs/GetVisualNames")