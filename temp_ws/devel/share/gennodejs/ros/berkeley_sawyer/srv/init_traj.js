...
class init_trajRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type init_trajRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type init_trajRequest
    let len;
    let data = new init_trajRequest(null);
  ...
  static datatype() {
    ...
    return 'berkeley_sawyer/init_trajRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new init_trajRequest(null);
...
class init_trajResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type init_trajResponse
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type init_trajResponse
    let len;
    let data = new init_trajResponse(null);
    return data;
  }
  ...
  static datatype() {
    // Returns string type for a service object
    return 'berkeley_sawyer/init_trajResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new init_trajResponse(null);
    return resolved;
    }
};

module.exports = {
  Request: init_trajRequest,
  Response: init_trajResponse,
  md5sum() { return '58b1b06ba616229bc38a06a0a0af5730'; },
  datatype() { return 'berkeley_sawyer/init_traj'; }
};
