...
class Logger(object):
    ...
    def __init__(self, output_dir=None, output_fname='progress.txt', exp_name=None, seed=0):
        """
        Initialize a Logger.
...
class EpochLogger(Logger):
    ...
    def __init__(self, output_dir='', exp_name='', seed=0):
        super(EpochLogger, self).__init__(output_dir=output_dir, exp_name=exp_name, seed=seed)
    ...
    # ================================================================
    # Saving variables, Adopted from OpenAI Baseline
    # ================================================================

    def load_weight(self, fname, sess=None, var_list=None):
        """
        ...
        saver.restore(sess,tf.train.latest_checkpoint(fname))


    def save_weight(self, fname, sess=None, var_list=None, step=None):
        """
        ...
        print ('============ Saves trained model weight @ :' + fname + '============')

        # os.makedirs(dir_name, exist/_ok=True)
 
        saver = tf.train.Saver(var_list=var_list)
        saver.save(sess, fname, global_step = step)
        print ('============ Successfully saved model weight ============')