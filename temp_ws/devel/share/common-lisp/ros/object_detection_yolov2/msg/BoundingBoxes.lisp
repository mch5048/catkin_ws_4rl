...
(cl:defclass <BoundingBoxes> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (bounding_boxes
    ...
    :type (cl:vector object_detection_yolov2-msg:BoundingBox)
   :initform (cl:make-array 0 :element-type 'object_detection_yolov2-msg:BoundingBox :initial-element (cl:make-instance 'object_detection_yolov2-msg:BoundingBox))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <BoundingBoxes>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoundingBoxes)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_detection_yolov2-msg:<BoundingBoxes> is deprecated: use object_detection_yolov2-msg:BoundingBoxes instead.")))
...
(cl:defmethod image_header-val ((m <BoundingBoxes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_detection_yolov2-msg:image_header-val is deprecated.  Use object_detection_yolov2-msg:image_header instead.")
  (image_header m))

(cl:ensure-generic-function 'bounding_boxes-val :lambda-list '(m))
(cl:defmethod bounding_boxes-val ((m <BoundingBoxes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_detection_yolov2-msg:bounding_boxes-val is deprecated.  Use object_detection_yolov2-msg:bounding_boxes instead.")
  (bounding_boxes m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <BoundingBoxes>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'bounding_boxes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'object_detection_yolov2-msg:BoundingBox))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BoundingBoxes>)))
  ...
  "object_detection_yolov2/BoundingBoxes")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BoundingBoxes)))
  "Returns string type for a message object of type 'BoundingBoxes"
  "object_detection_yolov2/BoundingBoxes")
