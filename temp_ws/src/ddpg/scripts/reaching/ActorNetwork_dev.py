...
class ActorNetwork(object):
    def __init__(self, sess, state_rgb, state_robot, action_size, BATCH_SIZE, TAU, LEARNING_RATE, critic_full_input, critic_obj_input, critic_model):
        ...
        self.actor_loss = -tf.reduce_mean(self.critic_model([self.critic_full_input, self.critic_obj_input, self.model([self.state_rgb, self.state_rob])])[0])
    ...
    def train_actor(self, states_rgb, states_rob, critic_full_input, critic_obj_input):
    ...
    def create_actor_network(self, state_rgb,state_robot,action_dim):
        ...
        AH1= Conv2D(32, (4, 4), strides=(2,2), kernel_initializer='glorot_uniform', padding='valid', activation='relu', input_shape=(FRAME_WIDTH, FRAME_HEIGHT, CHANNELS))(S_rgb)
                # BFC1 = BatchNormalization()(  F)
        AH2= Conv2D(32, (4, 4), strides=(2,2), kernel_initializer='glorot_uniform', padding='valid', activation='relu')(AH1)
        AH3= Conv2D(32, (4, 4), strides=(2,2), kernel_initializer='glorot_uniform', padding='valid', activation='relu')(AH2)
        # AH4= Conv2D(32, (4, 4),  strides=(2,2), kernel_initializer='glorot_normal', padding='valid', activation='relu')(AH3)
        F = Flatten()(AH3)
        # FC1 = Dense(300, kernel_initializer='he_uniform',activation='relu', kernel_regularizer=regularizers.l2(0.01))(F)
        FC1 = Dense(300, activation='relu')(F)

        Concatd = Concatenate()([FC1, S_robot])
        ...
        FC2= Dense(300,kernel_initializer='glorot_uniform' )(AFC1)
        BFC2 = BatchNormalization()(FC2)
        AFC2 = Activation('relu')(BFC2)
        FC3= Dense(300, kernel_initializer='glorot_uniform')(AFC2)
