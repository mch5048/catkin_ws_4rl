...
"""autogenerated by genpy from object_detection_yolov2/BoundingBoxes.msg. Do not edit."""
import sys
...
class BoundingBoxes(genpy.Message):
  ...
  _type = "object_detection_yolov2/BoundingBoxes"
...
"""
  ...
  _slot_types = ['std_msgs/Header','std_msgs/Header','object_detection_yolov2/BoundingBox[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = object_detection_yolov2.msg.BoundingBox()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
