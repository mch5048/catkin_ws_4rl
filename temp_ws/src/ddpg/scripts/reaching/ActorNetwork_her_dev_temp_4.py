...
class ActorNetwork(object):
    def __init__(self, sess, state_rgb, state_robot, action_size, goal_rgb, BATCH_SIZE, TAU, LEARNING_RATE, critic_full_input, critic_obj_input, critic_goal_state, critic_model):
        ...
        with tf.variable_scope('actor_loss'):     
            ...
            self.actor_loss = tf.multiply(self.isPretrain, -tf.reduce_mean(self.priority_weight*critic_model([self.critic_full_input, self.critic_obj_input, self.critic_goal_state, self.joint_vel_scale* self.model([self.state_rgb, self.state_rob, self.goal_rgb])])[0]), name='actor_main_loss')
            # Behaviour cloning
            ...
            self.actor_total_loss = tf.add( self.actor_loss, self.bc_loss, name='actor_total_loss')
...
# Parameter Space Noise # Parameter Space Noise # Parameter Space Noise # Parameter Space Noise # Parameter Space Noise
    ...
    def train_actor_with_flatgrad(self, states_rgb, states_rob, goal_rgb, critic_full_input, critic_obj_input, critic_goal_state, sampled_action, isDemo, isPretrain, priority_weights):
        ...
        actor_flatgrad, self.train_summary = self.sess.run(train_op, feed_dict={   
            ...
            self.priority_weight : priority_weights,
            })
    ...
    #         AH1= Conv2D(32, (8, 8), strides=(4,4), kernel_initializer='glorot_normal', padding='valid', input_shape=(FRAME_WIDTH, FRAME_HEIGHT, CHANNELS),name='actor_conv1' ,trainable=trainable)(S_rgb)
    ...
    #         AH2= Conv2D(32, (4, 4), strides=(2,2), kernel_initializer='glorot_normal', padding='valid', name='actor_conv2',trainable=trainable)(A1)
    ...
    #         AH3= Conv2D(32, (3, 3), strides=(1,1), kernel_initializer='glorot_normal', padding='valid', name='actor_conv3',trainable=trainable)(A2)
    ...
    #         #################################################################################################################################################
    #         AGH1= Conv2D(32, (8, 8), strides=(4,4), kernel_initializer='glorot_normal', padding='valid', name='actor_goal_conv1',trainable=trainable, input_shape=(FRAME_WIDTH, FRAME_HEIGHT, CHANNELS))(G_rgb)
    #         # LNG1 = Lambda(self.Layer_Normalization, name = "layer_norm4")(AGH1) # Q is scalar value!! dimenstion should be 1
    #         A4 = Activation('relu')(AGH1)
    #         # A4 = Activation('tanh')(AGH1)

    #         AGH2= Conv2D(32, (4, 4), strides=(2,2), kernel_initializer='glorot_normal', padding='valid', name='actor_goal_conv2',trainable=trainable)(A4)
    #         # LNG2 = Lambda(self.Layer_Normalization, name = "layer_norm5")(AGH2) # Q is scalar value!! dimenstion should be 1
    #         A5 = Activation('relu')(AGH2)
    #         # A5 = Activation('tanh')(AGH2)

    #         AGH3= Conv2D(32, (3, 3), strides=(1,1), kernel_initializer='glorot_normal', padding='valid', name='actor_goal_conv3',trainable=trainable)(A5)
    ...
    #         FC1 = Dense(512, kernel_initializer='glorot_normal', name='actor_fc1',trainable=trainable)(Concatd2)
    #         LNFC2 = Lambda(self.Layer_Normalization, name = "layer_norm8")(FC1) # Q is scalar value!! dimenstion should be 1
    #         # A8 = Activation('relu')(LNFC2)
    ...
    #         FC2= Dense(256,kernel_initializer='glorot_normal', name='actor_fc2',trainable=trainable)(AFC1)
    #         LNFC3 = Lambda(self.Layer_Normalization, name = "layer_norm9")(FC2) # Q is scalar value!! dimenstion should be 1
    #         # A9 = Activation('relu')(LNFC3)         
