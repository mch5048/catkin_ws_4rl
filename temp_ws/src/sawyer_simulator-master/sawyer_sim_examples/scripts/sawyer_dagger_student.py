...
def main():
    ...
    pub2 = rospy.Publisher('/ddpg/reset2', JointCommand, queue_size=1)
    ...
    starting_joint_angles = {'right_j0': -0.041662954890248294,
                             'right_j1': .5258291091425074,
                             'right_j2': 0.0293680414401436,
                             'right_j3': 1.17518162913313,
    ...
    while not rospy.is_shutdown():
        rospy.wait_for_message("/ddpg/reset", JointCommand)
        rand_x = uniform(0.5, .7)
        rand_y = uniform(-0.4, 0.4)
        pose = Pose(position=Point(x=rand_x, y=rand_y, z=0.7825))
        load_gazebo_block(block_pose=pose)
