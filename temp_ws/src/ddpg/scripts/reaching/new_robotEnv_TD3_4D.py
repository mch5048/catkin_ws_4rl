...
class robotEnv():
    def __init__(self, max_steps=700, isdagger=False, train_indicator=False):
        #init code
    ...
    def solveIK(self, cartesian, isReal=False):
        cartesian = cartesian
        ...
        self._servo_to_pose(ik_pose, isReal=isReal)
...
#         return objectPose_robotFrame1
    ...
    def _servo_to_pose(self, pose, time=1.0, steps=1.0, isReal=False):
        ...
        ik_delta.position.z =   pose.position.z  / steps + current_pose['position'].z # - 0.14 if isReal else 0
        # if isReal:
        #     ik_delta.position.z -= 0.14
...
# DAgger #DAgger #DAgger #DAgger #DAgger #DAgger #DAgger #DAgger #DAgger #DAgger #DAgger #DAgger
 ...
 #DAgger #DAgger #DAgger #DAgger #DAgger #DAgger #DAgger #DAgger #DAgger #DAgger #DAgger #DAgger
    ...
    def step(self,vals, step, isReal=False):
        ...
        # appy action
        self.solveIK(act, isReal=isReal)
