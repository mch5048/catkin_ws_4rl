...
DAGGER_STEPS = 200        # maximum step for a game
...
if __name__ == '__main__':
    ...
    data_aggr_list = []
    env = robotEnv(max_steps=700, isdagger=True)
    limb = Limb()
    env.isDemo = True
    ...
    for e in range(episode_count):
        ...
        for s in range(max_steps):
            ...
            # s_t_1[0] = normalize(s_t_1[0], s_t0_rms) # DO NOT NORMALIZE VISUAL OBSERVATION
        ...
        #     norm_goal_obs_actor = goal_obs_actor # DO NOT NORMALIZE VISUAL OBSERVATION
        #     # norm_goal_obs_actor = normalize(goal_obs_actor, goal_obs_rms) # DO NOT NORMALIZE VISUAL OBSERVATION
