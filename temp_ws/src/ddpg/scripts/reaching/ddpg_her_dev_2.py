...
from ActorNetwork_her_dev_temp_2 import ActorNetwork
from CriticNetwork_her_dev_2 import CriticNetwork
...
LOSS_COEF_DICT = {'onestep':0.9, 'Nstep':0.1, 'L2coef':0.01}
...
def playGame(train_indicator=0):    #1 means Train, 0 means simply Run
 ...
 # goal state critic is 7 joint positions 
        ...
        for j in range(max_steps):
            ...
            # print '~~~~~~~~~~~~~~~~~~~~Check contents of observation~~~~~~~~~~~~~~~~~~~~'
            # print '~~~~~~~~~~~~~~~~~~~~Check contents of observation~~~~~~~~~~~~~~~~~~~~'
            # print s_t_1[0]
            # print '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
            # print '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
            ...
            # print '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
            # print '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
            # print achvd_obs_actor


            cv2.imwrite('/home/cheolhui/catkin_ws/src/ddpg/scripts/goal_obs.png', goal_obs_actor_norm[0])
            cv2.imwrite('/home/cheolhui/catkin_ws/src/ddpg/scripts/achvd_obs.png', achvd_obs_actor[0])
            cv2.imwrite('/home/cheolhui/catkin_ws/src/ddpg/scripts/s_t_1.png', s_t_1[0][0])
            ...
            goal_obs_rms.update(goal_obs_actor_norm)
        ...
        for updates in range(MAX_UPDATES):
            ...
            if (train_indicator): #training mode
                ...
                with tf.variable_scope('train_actor'):
                    # value_grad_to_action_Critic = critic.get_value_grad_to_action(reduced_full_state_t, reduced_sampled_obj_state, goal_states_Crit, sampled_img_state, sampled_joint_pos_state,goal_states_Actr)
                    # feed dict on the bottom line!
                    actor.train_actor_with_gradient(reduced_full_state_t, reduced_sampled_obj_state, goal_states_Crit, sampled_img_state, sampled_joint_pos_state,goal_states_Actr)
                ...
                # print n_step_loss
                # print '11111111111111111111'
                # print one_step_losss

                buff.update_priorities(indices, td_err_n, td_err_1)
        ...
        print ("onestep_loss", onestep_loss, "Nstep_loss", Nstep_loss, "L2_loss", l2_loss)
