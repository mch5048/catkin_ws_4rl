...
(cl:defmethod cl:initialize-instance :after ((m <GoalObs>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GoalObs)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ddpg-msg:<GoalObs> is deprecated: use ddpg-msg:GoalObs instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <GoalObs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ddpg-msg:header-val is deprecated.  Use ddpg-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'goal_cart_pos-val :lambda-list '(m))
(cl:defmethod goal_cart_pos-val ((m <GoalObs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ddpg-msg:goal_cart_pos-val is deprecated.  Use ddpg-msg:goal_cart_pos instead.")
  (goal_cart_pos m))
