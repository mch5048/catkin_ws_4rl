...
(cl:defmethod cl:initialize-instance :after ((m <PosCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PosCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sawyer_sim_examples-msg:<PosCmd> is deprecated: use sawyer_sim_examples-msg:PosCmd instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <PosCmd>))
...
(cl:defmethod goal_cart_pos-val ((m <PosCmd>))
