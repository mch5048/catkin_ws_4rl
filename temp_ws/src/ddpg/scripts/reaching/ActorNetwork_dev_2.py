...
class ActorNetwork(object):
    ...
    def create_actor_network(self, state_rgb,state_robot,action_dim):
        ...
        # AH4= Conv2D(32, (4, 4),  strides=(2,2), kernel_initializer='glorot_uniform', padding='valid', activation='relu')(AH3)
        F = Flatten()(AH3)
        # FC1 = Dense(300, kernel_initializer='he_uniform',activation='relu', kernel_regularizer=regularizers.l2(0.01))(F)
        FC1 = Dense(400, kernel_initializer='glorot_uniform' ,activation='relu')(F)
        ...
        FC2= Dense(450, kernel_initializer='glorot_uniform' )(AFC1)
        BFC2 = BatchNormalization()(FC2)
        AFC2 = Activation('relu')(BFC2)
        FC3= Dense(450, kernel_initializer='glorot_uniform' )(AFC2)
