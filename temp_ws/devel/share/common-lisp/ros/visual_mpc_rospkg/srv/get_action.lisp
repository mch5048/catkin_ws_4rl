...
(cl:defmethod cl:initialize-instance :after ((m <get_action-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'get_action-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name visual_mpc_rospkg-srv:<get_action-request> is deprecated: use visual_mpc_rospkg-srv:get_action-request instead.")))

(cl:ensure-generic-function 'main-val :lambda-list '(m))
(cl:defmethod main-val ((m <get_action-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader visual_mpc_rospkg-srv:main-val is deprecated.  Use visual_mpc_rospkg-srv:main instead.")
  (main m))

(cl:ensure-generic-function 'aux1-val :lambda-list '(m))
(cl:defmethod aux1-val ((m <get_action-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader visual_mpc_rospkg-srv:aux1-val is deprecated.  Use visual_mpc_rospkg-srv:aux1 instead.")
  (aux1 m))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <get_action-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader visual_mpc_rospkg-srv:state-val is deprecated.  Use visual_mpc_rospkg-srv:state instead.")
  (state m))

(cl:ensure-generic-function 'desig_pos_aux1-val :lambda-list '(m))
(cl:defmethod desig_pos_aux1-val ((m <get_action-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader visual_mpc_rospkg-srv:desig_pos_aux1-val is deprecated.  Use visual_mpc_rospkg-srv:desig_pos_aux1 instead.")
  (desig_pos_aux1 m))

(cl:ensure-generic-function 'goal_pos_aux1-val :lambda-list '(m))
(cl:defmethod goal_pos_aux1-val ((m <get_action-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader visual_mpc_rospkg-srv:goal_pos_aux1-val is deprecated.  Use visual_mpc_rospkg-srv:goal_pos_aux1 instead.")
  (goal_pos_aux1 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<get_action-request>)))
  ...
  "visual_mpc_rospkg/get_actionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'get_action-request)))
  "Returns string type for a service object of type 'get_action-request"
  "visual_mpc_rospkg/get_actionRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <get_action-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'get_action-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name visual_mpc_rospkg-srv:<get_action-response> is deprecated: use visual_mpc_rospkg-srv:get_action-response instead.")))

(cl:ensure-generic-function 'action-val :lambda-list '(m))
(cl:defmethod action-val ((m <get_action-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader visual_mpc_rospkg-srv:action-val is deprecated.  Use visual_mpc_rospkg-srv:action instead.")
  (action m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<get_action-response>)))
  ...
  "visual_mpc_rospkg/get_actionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'get_action-response)))
  "Returns string type for a service object of type 'get_action-response"
  "visual_mpc_rospkg/get_actionResponse")
