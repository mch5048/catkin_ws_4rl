...
# def record_demo_joint_values():
#     print("Record the teacher's guidance")
#     joint_0_record.append(deg(limb.joint_angle('right_j0')))
#     joint_1_record.append(deg(limb.joint_angle('right_j1')))
#     joint_2_record.append(deg(limb.joint_angle('right_j2')))
#     joint_3_record.append(deg(limb.joint_angle('right_j3')))
#     joint_4_record.append(deg(limb.joint_angle('right_j4')))
#     joint_5_record.append(deg(limb.joint_angle('right_j5')))
#     joint_6_record.append(deg(limb.joint_angle('right_j6')))


#     joint_0_record_np = np.array(joint_0_record)
#     joint_1_record_np = np.array(joint_1_record)
#     joint_2_record_np = np.array(joint_2_record)
#     joint_3_record_np = np.array(joint_3_record)
#     joint_4_record_np = np.array(joint_4_record)
#     joint_5_record_np = np.array(joint_5_record)
#     joint_6_record_np = np.array(joint_6_record)
#     save_data = np.column_stack((joint_0_record_np,
#                                       joint_1_record_np,
#                                       joint_2_record_np,
#                                       joint_3_record_np,
#                                       joint_4_record_np,
...
if __name__ == '__main__':
    ...
    for e in range(episode_count):
        ...
        color_obs_t, joint_pos_t, joint_vels_t = env.reset_teaching()
        ...
        for s in range(max_steps):
            ...
            rospy.sleep(0.04) # to meet the delta_T

            dist, color_obs_t_1, joint_pos_t_1, joint_vels_t_1, r_t, done = env.step_teaching(step)
            ...
            if len(memory) >= (N_STEP_RETURN): # if buffer has more than 4 memories, execute
                ...
                data_aggr_list.append((s_t, a_t, discount_r, s_t_1, done))      #A s_t , s_t+N, a_t+N, disc_r
