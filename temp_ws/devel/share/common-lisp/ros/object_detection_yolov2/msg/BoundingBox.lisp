...
(cl:defmethod cl:initialize-instance :after ((m <BoundingBox>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoundingBox)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_detection_yolov2-msg:<BoundingBox> is deprecated: use object_detection_yolov2-msg:BoundingBox instead.")))

(cl:ensure-generic-function 'Class-val :lambda-list '(m))
(cl:defmethod Class-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_detection_yolov2-msg:Class-val is deprecated.  Use object_detection_yolov2-msg:Class instead.")
  (Class m))

(cl:ensure-generic-function 'probability-val :lambda-list '(m))
(cl:defmethod probability-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_detection_yolov2-msg:probability-val is deprecated.  Use object_detection_yolov2-msg:probability instead.")
  (probability m))

(cl:ensure-generic-function 'xmin-val :lambda-list '(m))
(cl:defmethod xmin-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_detection_yolov2-msg:xmin-val is deprecated.  Use object_detection_yolov2-msg:xmin instead.")
  (xmin m))

(cl:ensure-generic-function 'ymin-val :lambda-list '(m))
(cl:defmethod ymin-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_detection_yolov2-msg:ymin-val is deprecated.  Use object_detection_yolov2-msg:ymin instead.")
  (ymin m))

(cl:ensure-generic-function 'xmax-val :lambda-list '(m))
(cl:defmethod xmax-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_detection_yolov2-msg:xmax-val is deprecated.  Use object_detection_yolov2-msg:xmax instead.")
  (xmax m))

(cl:ensure-generic-function 'ymax-val :lambda-list '(m))
(cl:defmethod ymax-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_detection_yolov2-msg:ymax-val is deprecated.  Use object_detection_yolov2-msg:ymax instead.")
  (ymax m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BoundingBox>)))
  ...
  "object_detection_yolov2/BoundingBox")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BoundingBox)))
  "Returns string type for a message object of type 'BoundingBox"
  "object_detection_yolov2/BoundingBox")
