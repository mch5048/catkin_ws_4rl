...
# from rviz_markers_sawyer import MarkerBasics
...
class PickAndPlace(object):
    ...
    def init_rviz_markers_sawyer(self):
        """
        ...
        '''
            Sawyer Mesh list
            Base :  <mesh filename="package://sawyer_description/meshes/sawyer_pv/base.DAE"/>
            L0 :    <mesh filename="package://sawyer_description/meshes/sawyer_mp3/l0.DAE"/>
            Head :  <mesh filename="package://sawyer_description/meshes/sawyer_pv/head.DAE"/>
            L1 :    <mesh filename="package://sawyer_description/meshes/sawyer_mp3/l1.DAE"/>
            L2 :    <mesh filename="package://sawyer_description/meshes/sawyer_pv/l2.DAE"/>
            L3 :    <mesh filename="package://sawyer_description/meshes/sawyer_pv/l3.DAE"/>
            L4 :    <mesh filename="package://sawyer_description/meshes/sawyer_pv/l4.DAE"/>
            L5 :    <mesh filename="package://sawyer_description/meshes/sawyer_pv/l5.DAE"/>
            L6 :    <mesh filename="package://sawyer_description/meshes/sawyer_mp1/l6.DAE"/>
        '''

        # Cafe table

        marker_type = "mesh"
        namespace = "cafe_table"
        mesh_package_path = ""
        self.mark_cafe_table = MarkerBasics(type=marker_type,
                                          namespace=namespace,
                                          index=0,
                                          red=0.0,
                                          green=0.0,
        ...
        marker_type = "mesh"
        namespace = "sawyer_head"
        # mesh_package_path = "dynamic_objects/models/demo_spam/meshes/nontextured_fixed.stl"
        mesh_package_path = "sawyer_description/meshes/sawyer_pv/meshes/head.STL"
    
        self.mark_sawyer_head = MarkerBasics(type=marker_type,
                                            namespace=namespace,
                                            index=0,
                                            red=1.0,
                                            green=0.0,
        ...
        marker_type = "mesh"
        namespace = "sawyer_base"
        # mesh_package_path = "dynamic_objects/models/demo_spam/meshes/nontextured_fixed.stl"
        mesh_package_path = "sawyer_description/meshes/sawyer_pv/meshes/base.STL"
    
        self.mark_sawyer_base = MarkerBasics(type=marker_type,
                                            namespace=namespace,
                                            index=0,
                                            red=1.0,
                                            green=0.0,
        ...
        namespace = "sawyer_l0"
        # mesh_package_path = "dynamic_objects/models/demo_spam/meshes/nontextured_fixed.stl"
        mesh_package_path = "sawyer_description/meshes/sawyer_mp3/meshes/l0.STL"
    
        self.mark_sawyer_l0 = MarkerBasics(type=marker_type,
                                            namespace=namespace,
                                            index=0,
                                            red=1.0,
                                            green=0.0,
        ...
        namespace = "sawyer_l1"
        # mesh_package_path = "dynamic_objects/models/demo_spam/meshes/nontextured_fixed.stl"
        mesh_package_path = "sawyer_description/meshes/sawyer_mp3/meshes/l1.STL"
    
        self.mark_sawyer_l1 = MarkerBasics(type=marker_type,
                                            namespace=namespace,
                                            index=0,
                                            red=1.0,
                                            green=0.0,
        ...
        namespace = "sawyer_l2"
        # mesh_package_path = "dynamic_objects/models/demo_spam/meshes/nontextured_fixed.stl"
        mesh_package_path = "sawyer_description/meshes/sawyer_pv/meshes/l2.STL"
    
        self.mark_sawyer_l2 = MarkerBasics(type=marker_type,
                                            namespace=namespace,
                                            index=0,
                                            red=1.0,
                                            green=0.0,
        ...
        namespace = "sawyer_l3"
        # mesh_package_path = "dynamic_objects/models/demo_spam/meshes/nontextured_fixed.stl"
        mesh_package_path = "sawyer_description/meshes/sawyer_pv/meshes/l3.STL"
    
        self.mark_sawyer_l3 = MarkerBasics(type=marker_type,
                                            namespace=namespace,
                                            index=0,
                                            red=1.0,
                                            green=0.0,
        ...
        namespace = "sawyer_l4"
        # mesh_package_path = "dynamic_objects/models/demo_spam/meshes/nontextured_fixed.stl"
        mesh_package_path = "sawyer_description/meshes/sawyer_pv/meshes/l4.STL"
    
        self.mark_sawyer_l4 = MarkerBasics(type=marker_type,
                                            namespace=namespace,
                                            index=0,
                                            red=1.0,
                                            green=0.0,
        ...
        namespace = "sawyer_l5"
        # mesh_package_path = "dynamic_objects/models/demo_spam/meshes/nontextured_fixed.stl"
        mesh_package_path = "sawyer_description/meshes/sawyer_pv/meshes/l5.STL"
    
        self.mark_sawyer_l5 = MarkerBasics(type=marker_type,
                                            namespace=namespace,
                                            index=0,
                                            red=1.0,
                                            green=0.0,
        ...
        namespace = "sawyer_l6"
        # mesh_package_path = "dynamic_objects/models/demo_spam/meshes/nontextured_fixed.stl"
        mesh_package_path = "sawyer_description/meshes/sawyer_mpl/meshes/l6.STL"
    
        self.mark_sawyer_l6 = MarkerBasics(type=marker_type,
                                            namespace=namespace,
                                            index=0,
                                            red=1.0,
                                            green=0.0,
    ...
    def _servo_to_pose(self, pose, publisher=None, time=4.0, steps=400.0):
        ''' An *incredibly simple* linearly-interpolated Cartesian move '''
        # r = rospy.Rate(1/(time/steps)) # Defaults to 100Hz command rate
        xyz_pub = publisher
        r = rospy.Rate(66.7) # Defaults to 100Hz command rate
        current_pose = self._limb.endpoint_pose()
        ik_delta = Pose()
        ...
        poscmd.header = Header()
        poscmd.goal_cart_pos = [ik_delta.position.x, ik_delta.position.y, ik_delta.position.z]
        # xyz_pub.publish(poscmd)
        for d in range(int(steps), -1, -1):
            if rospy.is_shutdown():
                return

            # for shooting demo videos ## for shooting demo videos
            if d %4:
                print '======================'
                print ik_delta.position.x              
                print ik_delta.position.y              
                print ik_delta.position.z    
                print '======================'

                ik_delta.position.x += np.random.normal(0.0, 7e-7)
                ik_delta.position.y += np.random.normal(0.0, 7e-7)
                ik_delta.position.z += np.random.normal(0.0, 5e-7)
                ik_delta.orientation.x += np.random.normal(0.0, 5e-6)
                ik_delta.orientation.y += np.random.normal(0.0, 5e-6)
                ik_delta.orientation.z += np.random.normal(0.0, 5e-6)
                ik_delta.orientation.w += np.random.normal(0.0, 5e-6)
            # for shooting demo videos ## for shooting demo videos
            xyz_pub.publish(poscmd) # coordinate the publish rate
            ik_step = Pose()
            ...
            if joint_angles:
                self._limb.set_joint_positions(joint_angles) # just publish. no response followed
            else:
                rospy.logerr("No Joint Angles provided for move_to_joint_positions. Staying put.")
            r.sleep()
        rospy.sleep(1.0)
    ...
    def reach(self, pose, poscmdPub):
        ...
        steps = time *100.0
        self._servo_to_pose(pose=pose, publisher= poscmdPub, time=time, steps=steps)
        if rospy.is_shutdown():
            return
        # close gripper
